...
/**
  ...
  *     - 12.12.2019 (SVD 2.1): fix PWM->HDCLR missing fields
  */
...
typedef struct {
  ...
  uint32_t CBC                                    :1;                   /*!< Clear flag CBC */
  uint32_t OST                                    :1;                   /*!< Clear flag OST */
  uint32_t Reserved0                              :29;                  /*!< Reserved */
} _PWM_HDCLR_bits;

/* Bit field positions: */
#define PWM_HDCLR_HDINT_Pos                                 0           /*!< Clear flag HDINT */
#define PWM_HDCLR_CBC_Pos                                   1           /*!< Clear flag CBC */
#define PWM_HDCLR_OST_Pos                                   2           /*!< Clear flag OST */

/* Bit field masks: */
#define PWM_HDCLR_HDINT_Msk                                 0x00000001  /*!< Clear flag HDINT */
#define PWM_HDCLR_CBC_Msk                                   0x00000002  /*!< Clear flag CBC */
#define PWM_HDCLR_OST_Msk                                   0x00000004  /*!< Clear flag OST */
